...
export default function HeroSection() {
  ...
  const { email, heroTitle, heroDescription } = personalData;
  ...
  return (
    <section
      id="home"
      className="min-h-screen lg:h-screen flex flex-col relative overflow-hidden bg-primary-bg"
    >
      ...
      {/* Hero Content */}
      <div className="flex-grow flex items-center px-6 lg:px-16 py-12 lg:py-0 lg:pb-16 relative z-10">
